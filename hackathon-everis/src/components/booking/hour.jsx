  ...
  return (
    <div className="container">
      <div className="date-container">
        ...
        <button class="btn-addhour" onClick={() => dispatch(blockHour)}>Agregar hora</button>
        <div>
          <select class="bnt-select" onChange={onChangeQuantity}>
        ...
        <button class="btn-addhour" onClick={() => dispatch2(quantity)}>Agregar cantidad</button>
      </div>
